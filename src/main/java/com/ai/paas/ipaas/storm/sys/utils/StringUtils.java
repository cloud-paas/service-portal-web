...
import com.ai.paas.ipaas.storm.sys.exception.BusiException;
/**
 * 字符串工具类
 */
public class StringUtils extends org.springframework.util.StringUtils{
	...
	public static String trimOrNullException(String source, String msg) {
		if (source == null) {
			throw new BusiException("请输入【" + msg + "】");
		} else {
			return source.trim();
		}
	}
	...
	public static long trimLongException(String source, String msg) {
		if (isBlank(source)) {
			throw new BusiException("trimLongException【" + msg + "】"+"["+source+"]");
		} else {
			try {
				return Long.parseLong(source);
			} catch (Exception e) {
				throw new BusiException("trimLongException(不是long数值)【" + msg + "】");
			}
		}
	}
	/**
	...
	public static int trimIntException(String source, String msg) {
		if (isBlank(source)) {
			throw new BusiException("trimIntException【" + msg + "】");
		} else {
			try {
				return Integer.parseInt(source);
			} catch (Exception e) {
				throw new BusiException("trimIntException(不是int数值)【" + msg + "】");
			}
		}
	}
	/**
