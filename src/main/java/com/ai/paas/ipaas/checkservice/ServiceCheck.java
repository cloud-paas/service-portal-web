...
public class ServiceCheck {
	...
	private static Map<String, Object> testCCSIN() {
		try {
			...
			ICCSComponent iCCSComponent = CCSComponentFactory.getConfigClient(ccs.split(",")[0], ccs.split(",")[1],
					ccs.split(",")[2]);
	...
	private static Map<String, Object> testMDS(String pid, String serviceId, String servicePwd, String topicId) {
		...
		msgSender.send("adsajddddddddddsadsadsa" + "dddddddddddddddddddasdsadsadsadd"
				...
				+ "asdddddddddddddddddddddddddddddddddddddddddasdsadsadsadsd" + "kkkkkkkkkkkkkkkkkkkkkdsa", 0);
