package com.ai.paas.ipaas.checkservice.base.orm;

import java.io.Serializable;
import java.util.List;
import java.util.Map;

import com.ai.paas.ipaas.checkservice.base.orm.page.model.PageEntity;
import com.ai.paas.ipaas.checkservice.base.orm.page.model.PagingResult;
...
public interface IGenericDao<T, PK extends Serializable> {
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public abstract List<T> getAllByParam(Map param);
