	...
	$.fn.fsvs = function( options ) {
		...
		var app = {
			...
			addPagination : function() {  
				$('.btn_td').bind( 'click.fsvs', function(e){ 
					ignoreHashChange = true;
					$(this).css("display","none");
					$(".btn_td2").css("display","block");    
					$(".btn_td2 img").removeClass("hidden"); 
					app.slideToIndex( 1, e );
		
				});
				$('.btn_td2').bind( 'click.fsvs', function(e){ 
					ignoreHashChange = true; 
					$(this).css("display","none");
					$(".btn_td").css("display","block"); 
					$(".btn_td2 img").addClass("hidden"); 
			...
			slideToIndex : function( index, e ) {
				if(index == 1) {$(".btn_td2 img").removeClass("hidden");}
				var e = e || false;
				if( ! e && pagination ) {
