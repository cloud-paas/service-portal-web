      ...
      <div class="list_groups">
            ...
            <ul>
             ...
             <p><A href="${_base }/help/mail"><span style="margin-top:2px;">Iaas资源申请流程</span></A></p>
              <p class="xuanz"><A href="${_base }/help/paas"><span style="margin-top:2px;">Paas资源申请</span></A></p>
             </li>
             </li>
             </ul>
...
户中心－消息通知查看</li>
    ...
    <ul>
    <li><img src="${_base }/resources/images/ia_6.png"></li>
    <li class="ziy_zi">使用SDK开发</li>
    <li>|</li>
    <li>下载SDK包、SDK使用说<br>
明文档进行Saas应用的开发</li>
    </ul>
