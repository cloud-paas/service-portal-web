        ...
        <div class="Open_cache_list"> 
          <div class="Open_cache_list_none">
			  ...
			  <ul style="float:left;width:55%;padding-left:3%;line-height:25px">
				...
				<li style="color:#949494">图片服务（Document store service）是基于MongoDB技术实现，对外提供海量，安全，低成本，高可靠的小型文件云存储服务，支持高并发读写。</li>
				<li>
					<a href="${_base}/idps/toOpenIdps"><div style="margin-top:20px;text-align:center;-moz-border-radius: 15px;border-radius: 15px;width:130px;height:30px;background:rgb(121,189,90);line-height:30px;vertical-align:middle;color:#fff">立即开通</div></a>
				</li>
			  </ul>
		 ...
		 <div class="tab_div" id="tab_div2">
		  ...
		  <div class="cache_pro_help">
				<ul style="float:left;padding-left:20%;">
					...
					<li><a href="javascript:void(0);" onclick="javascript:downloadFile('PaaS-DSS.docx','2')">IDPS使用说明书</a></li>
				</ul>
				<ul style="float:right;padding-left:10%">
					<li class="desc_title">常见问题</li>
					<li><a href="${_base }/help/FAQ#DSS1">IDPS是不是分布式存储？</a></li>
					<li><a href="${_base }/help/FAQ#DSS2">多大的数据文件适合存储在IDPS？</a></li>
