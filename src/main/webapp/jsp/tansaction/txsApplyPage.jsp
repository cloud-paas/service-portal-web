					...
					$(_this.settings.SUBMIT_ID).bind("click",function(){
						if ($("#myForm").valid()){
							...
							$.ajax({
								async : true,
								type : "POST",
								url : "${_base}/txs/txsApply",
								modal : true,
								showBusi : false,
								data : {
									servicePassword : my_password,
									my_name : my_name
								...
								success: function(data){
									...
									if(json&&json.code=="0000"){
										location.href=getContextPath() +"/mcs/applyCompleted?prod=TXS"; //&url=/txs/txsApplyPage&prodType=3
										$('.waitCover').hide();
									}else{
										$('.waitCover').hide();
     	...
     	<div class="Open_cache">  
	        <div class="Open_cache_list" style="margin:0"> 
	          	<div class="Open_cache_list_tow">
			          ...
			          <li class="font-title">事务保障服务TXS</li> 
		          	</ul>
		          	<ul>
