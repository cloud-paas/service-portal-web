	           ...
	           <div class="Open_cache_list_tow" style="vertical-align:middle; line-height:0px; padding:0px 0px 0px 0px">
				...
				<div class="Open_cache_list_tow" style="vertical-align:middle;line-height:30px;padding:20px 0px 0px 75px">
					...
					<a href="#" id="modify_button" style="float:left">
						<div style="margin:10px 0px 0px 0px;text-align:center;-moz-border-radius: 15px;border-radius: 15px;width:130px;height:32px;background:rgb(119,189,90);line-height:30px;vertical-align:middle;font-size:14px;font-weight:800;border:solid 1px rgb(204,204,204);color:#fff">确认</div>
					</a>
				    <a href="#" onclick="history.go(-1)" style="float:left">
				    	<div style="margin:10px 0px 0px 50px;text-align:center;-moz-border-radius: 15px;border-radius: 15px;width:130px;height:32px;background:rgb(230,230,230);line-height:30px;vertical-align:middle;color:#000;font-size:14px;font-weight:800;border:solid 1px rgb(204,204,204)">返回</div>
				    </a>
	           </div> 			   
	        </div>  
    	</div>   
