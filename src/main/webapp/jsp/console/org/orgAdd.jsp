				...
				$(_this.settings.ADD_BUTTON).bind("click",function(){
					if ($("#myForm").valid()){	
						...
						$.ajax({
							async : false,
							type : "POST",
							url : "${_base}/orgConsole/addOrgnize",
							dataType : 'json',
							data : {									
								orgCode : orgCode,
								orgName : orgName,
							...
							success: function(data){
								...
								alert("恭喜，添加组织成功!");
									location.href="${_base}/orgConsole/toOrgConsole";
								}else{									
									$("#add_error").text(json.resultMessage);
								}
							}
						});
					} 
  ...
  <div class="col-md-6 right_list">
     ...
     <div class="Open_cache">
		...
		<div class="Open_cache_table" style="background:rgb(245,245,245);height:30px;vertical-align:middle ;line-height:30px;padding-left:1%">
			 <span>组织ID：</span>
			 <span style="color:rgb(22,154,219)"> </span>
		</div>
     	...
     	<div class="Open_cache">  
	        <div class="Open_cache_list" style="margin:0"> 
				<div class="Open_cache_list_tow" style="vertical-align:middle; padding:0px 0px 0px 20px">
	          		 <table style="vertical-align:middle">
						<tr>
							...
							<td> 
								<div class="form-group" style="padding-top:5%">  
									 <input type="text" class="form-control" id="orgCode" name="orgCode" value='' style="width:300px">
								</div>
							</td>
						...
						<tr>
							...
							<td>
								<div class="form-group" style="padding-top:5%">  
									 <input type="text" class="form-control" id="orgName" name="orgName" value=''  style="width:300px">
								 </div>
							</td>
	           ...
	           <div class="Open_cache_list_tow" style="vertical-align:middle; line-height:5px; padding:0px 0px 0px 0px">
	          	 <label style="color:red;margin-left:80px;" id="add_error" ></label>	          		 
	           </div>    		
				<div class="Open_cache_list_tow" style="vertical-align:middle;line-height:32px;padding:10px 0px 0px 75px">
				
					<a href="#" id="add_button" style="float:left">
						<div style="margin:10px 0px 0px 0px;text-align:center;-moz-border-radius: 15px;border-radius: 15px;width:130px;height:32px;background:rgb(119,189,90);line-height:32px;vertical-align:middle;font-size:14px;font-weight:800;border:solid 1px rgb(204,204,204);color:#fff">添加</div>
					</a>
