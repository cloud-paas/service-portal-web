			...
			bindEvents : function(){
				...
				$(_this.settings.MODIFY_BUTTON).bind("click",function(){
					if ($("#myForm").valid()){	
						...
						if(oldPwd==newPwd) {
							$("#newPwd_error").text("新密码请不要和旧密码一致");
							return;
						}
						$.ajax({
							async : false,
							type : "POST",
							url : "${_base}/ccs/modifyCcsServPwd",
							modal : true,
							showBusi : false,
							data : {									
							...
							success: function(data){
								...
								if(json&&json.resultCode=="000000"){
									var parentUrl = "${_base}/config/showService";
									postRequest('${_base}/ccs/modifyCcsServPwdSuccess', {
										userServId : userServId,
										parentUrl : parentUrl
									});
								}else{
	        ...
	        <div class="Open_cache_list" style="margin:0"> 
				...
				<div class="Open_cache_list_tow" style="vertical-align:middle; padding:0px 0px 0px 20px">
	          		 <table style="vertical-align:middle">
						<tr>
							...
							<td> 
								<div class="form-group" style="padding-top:5%">  
									 <input type="password" class="form-control" id="oldPwd" name="oldPwd" style="width:300px">
								</div>
							</td>
						...
						<tr>
							...
							<td>
								<div class="form-group" style="padding-top:5%">  
									 <input type="password" class="form-control" id="newPwd" name="newPwd"  style="width:300px">
								 </div>
							</td>
						...
						<tr>
							...
							<td>
								<div class="form-group" style="padding-top:5%">  
									 <input type="password" class="form-control" id="reconfirm" name="reconfirm" style="width:300px">
								 </div>
							</td>
	           ...
	           <div class="Open_cache_list_tow" style="vertical-align:middle; line-height:0px; padding:0px 0px 0px 0px">
				...
				<div class="Open_cache_list_tow" style="vertical-align:middle;line-height:30px;padding:20px 0px 0px 75px">
				    ...
				    <a href="${_base}/config/showService" style="float:left">
