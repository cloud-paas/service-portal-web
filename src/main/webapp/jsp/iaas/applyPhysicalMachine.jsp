...
//    		$('.mune_2').css('padding-left', '1%');
   		$("#list_9").attr('style', 'margin-top:2px;color:#1699dc');
   	});
   </script>
 <script>
				...
				bindEvents : function(){
					...
					$(_this.settings.SUBMIT_ID).bind("click",function(){
							...
							$.ajax({
								async : false,
								type : "POST",
								url : "${_base}/iaas/savePhysicalMachineInfo",
								modal : true,
								showBusi : false,
								data : {
									my_sys : my_sys,
  ...
  <div class="col-md-6 right_list">
      ...
      <div  class="float_div">
		...
		<ul style="">
			<li class="float_div_title">物理机</li>
			<li id="xnj_li">
	 ...
	 <div class="Open_cache">
        ...
        <div class="Open_cache_list" style="margin-top:0px">  
           <table class="iaas_table" style="border-spacing:0px 10px;border-collapse:separate;"> 
				<tr>
					<td width="3%"  class="iaas_table_title" style="background:rgb(202,202,202);padding:0px 20px 0px 20px;border:solid 1px #eee">物理机</td>
	...
	init: function () {
		...
		f.btn.onmousedown = function (e) {
			...
			g.onmousemove = function (e) {
				...
				f.ondrag(m.round(m.max(0, to / max) * 200), to);
