							...
							$.ajax({
								...
								success: function(data){
									...
									if(json&&json.code=="0000"){
										location.href=getContextPath() +"/mcs/applyCompleted?prod=ATS"; //&url=/ats/atsApplyPage&prodType=3
										$('.waitCover').hide();
									}else{
     	...
     	<div class="Open_cache">  
	        <div class="Open_cache_list" style="margin:0"> 
	          	<div class="Open_cache_list_tow">
			          ...
			          <li class="font-title">最终事务一致ATS</li> 
		          	</ul>
		          	<ul>
