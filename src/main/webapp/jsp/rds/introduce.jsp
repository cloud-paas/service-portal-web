        ...
        <div class="Open_cache_list"> 
          <div class="Open_cache_list_none">
			  ...
			  <ul style="float:left;width:55%;padding-left:3%;line-height:25px">
				...
				<li style="color:#949494">云数据库服务（DATABASE Service）是基于Mysql技术实现，通过多个Mysql单实例（非Mysql Cluster）构成的一种水平拆分、可平滑扩缩容、读写分离的分布式数据库服务。</li>
				<li>
					<a href="${_base}/rds/toOpenRds"><div style="margin-top:20px;text-align:center;-moz-border-radius: 15px;border-radius: 15px;width:130px;height:30px;background:rgb(121,189,90);line-height:30px;vertical-align:middle;color:#fff">立即开通</div></a>
				</li>
			  </ul>
			...
			<table style="width:100%;height:100%;border-collapse:separate;border-spacing:10px 20px">
				<tr style="height:50%">
					<td>
						...
						<div style="height:80px;margin:0px 10px;">RDS底层自动实现对表的分片，保证每个片上的数据分布均匀，减轻每台数据库的读写压力，提升整体读写性能。</div>
					</td>
					<td>
				...
				<tr style="height:50%">
					...
					<td>
						...
						<div style="height:80px;margin:0px 10px;">对于应用层只需要像配置普通的数据源一样，配置一个RDS的数据源，就可以使用。</div>
					</td>
				</tr>
			</table>
		  </div>
		 ...
		 <div class="tab_div" id="tab_div2">
		  ...
		  <div class="cache_pro_help">
				<ul style="float:left;padding-left:20%;">
					...
					<li><a href="javascript:void(0);" onclick="javascript:downloadFile('PaaS-DBS.docx','2')">RDS使用说明书</a></li>
				</ul>
				<ul style="float:right;padding-left:10%">
					...
					<li><a href="${_base }/help/FAQ#DBS4">RDS是否出现不一致的情况，例如（事务提交过程中，数据库宕机）？</a></li>
